...
class DefaultPaymentActivity : AppCompatActivity() {
    var applicationId = "673af35386fd08d2213fc719"
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        if (BootpayBuildConfig.DEBUG) {
            applicationId = "673af35386fd08d2213fc719"
        }

        // 결제 버튼을 찾아 클릭 리스너 설정
        val paymentButton: Button = findViewById(R.id.confirmPaymentButton)
    ...
    fun PaymentTest(v: View?) {
        val extra = BootExtra()
            .setCardQuota("0,2,3") // 일시불, 2개월, 3개월 할부 허용할부는 최대 12개월까지 사용됨 (5만원 이상 구매시 할부허용 범위)
